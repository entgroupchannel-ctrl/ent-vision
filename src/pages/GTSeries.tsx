                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {[
                          ...
                          { name: "GT6000", tagline: "ดีไซน์ใหม่ i3", cpu: "Intel Core i3-5005U", ram: "DDR3L 4–8GB", com: 6, usb: 6, lan: 2, gpio: false, sim: false, display: "VGA+HDMI", price: "สอบถาม", cat: "standard", gen: "Gen 5" },
