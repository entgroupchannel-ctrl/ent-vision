...
export const aioProducts: AIOProduct[] = [
  /* ══════ BOX PC ══════ */
  {
    ...
    applications: [
      { icon: "🏭", titleTH: "ระบบควบคุมอุตสาหกรรม", titleEN: "Industrial Control" },
      { icon: "🏪", titleTH: "ระบบ POS ร้านค้า", titleEN: "POS System" },
      { icon: "📦", titleTH: "ระบบจัดการคลังสินค้า", titleEN: "Warehouse Management" },
      { icon: "🏥", titleTH: "ระบบสาธารณสุข", titleEN: "Healthcare" },
    ],
...

  {
    ...
    applications: [
      { icon: "🏪", titleTH: "ร้านค้าปลีก", titleEN: "Retail Store" },
      { icon: "📦", titleTH: "คลังสินค้า", titleEN: "Warehouse" },
      { icon: "🏭", titleTH: "โรงงานผลิต", titleEN: "Manufacturing" },
      { icon: "🚚", titleTH: "โลจิสติกส์", titleEN: "Logistics" },
    ],
    certifications: ["CE", "FCC"],
...

  {
    ...
    applications: [
      { icon: "🎓", titleTH: "การศึกษา", titleEN: "Education" },
      { icon: "🏥", titleTH: "สาธารณสุข", titleEN: "Healthcare" },
      { icon: "🚌", titleTH: "ขนส่งสาธารณะ", titleEN: "Public Transport" },
      { icon: "🏠", titleTH: "Smart Home", titleEN: "Smart Home" },
    ],
    certifications: ["CE", "FCC"],
    warranty: { standard: "1 ปี", support: "บริการซ่อมและเปลี่ยนอะไหล่โดยทีมวิศวกรผู้เชี่ยวชาญ", note: "ราคาอาจมีการเปลี่ยนแปลงโดยไม่แจ้งล่วงหน้า" },
  },

  {
    ...
    applications: [
      { icon: "🏪", titleTH: "ร้านค้า POS", titleEN: "POS System" },
      { icon: "🏭", titleTH: "อุตสาหกรรม", titleEN: "Industrial" },
      { icon: "📊", titleTH: "ระบบข้อมูล", titleEN: "Data Systems" },
      { icon: "🏥", titleTH: "สาธารณสุข", titleEN: "Healthcare" },
    ],
    certifications: ["CE", "FCC"],
  ...
  /* ══════ AIO DESKTOP ══════ */
  {
    ...
    applications: [
      { icon: "🖥️", titleTH: "สำนักงาน", titleEN: "Office" },
      { icon: "🏪", titleTH: "ร้านค้า", titleEN: "Retail" },
      { icon: "🏭", titleTH: "อุตสาหกรรม", titleEN: "Industrial" },
      { icon: "📊", titleTH: "ข้อมูล", titleEN: "Data" },
    ],
    certifications: ["CE", "FCC"],
    warranty: { standard: "1 ปี", support: "บริการซ่อมและเปลี่ยนอะไหล่", note: "ราคาอาจมีการเปลี่ยนแปลงโดยไม่แจ้งล่วงหน้า" },
  },
  ...
  /* ══════ PANEL PC ══════ */
  {
    ...
    applications: [
      { icon: "🏭", titleTH: "ระบบควบคุมอุตสาหกรรม", titleEN: "Industrial Automation" },
      { icon: "📱", titleTH: "แอพพลิเคชั่น", titleEN: "Custom Applications" },
      { icon: "🌐", titleTH: "ระบบเครือข่าย", titleEN: "Network Systems" },
      { icon: "⚙️", titleTH: "ระบบควบคุม", titleEN: "Control Systems" },
    ],
    certifications: ["CE", "FCC"],
    warranty: { standard: "1 ปี", support: "บริการซ่อมและเปลี่ยนอะไหล่โดยทีมวิศวกรผู้เชี่ยวชาญ", note: "ราคาอาจมีการเปลี่ยนแปลงโดยไม่แจ้งล่วงหน้า" },
  },

  {
    ...
    applications: [
      { icon: "🖥️", titleTH: "จอแสดงผล", titleEN: "Display Monitor" },
      { icon: "👆", titleTH: "ระบบสัมผัส", titleEN: "Touch Interface" },
      { icon: "🏭", titleTH: "อุตสาหกรรม", titleEN: "Industrial Use" },
      { icon: "📊", titleTH: "ระบบข้อมูล", titleEN: "Data Systems" },
    ],
    certifications: ["CE", "FCC"],
    warranty: { standard: "1 ปี", support: "บริการซ่อมและเปลี่ยนอะไหล่", note: "ราคาอาจมีการเปลี่ยนแปลงโดยไม่แจ้งล่วงหน้า" },
...

  {
    ...
    applications: [
      { icon: "🏭", titleTH: "ระบบควบคุมอุตสาหกรรม", titleEN: "Industrial Control" },
      { icon: "📡", titleTH: "ระบบสื่อสาร", titleEN: "Communication" },
      { icon: "⚡", titleTH: "ระบบไฟฟ้า", titleEN: "Power Systems" },
      { icon: "🌐", titleTH: "ระบบเครือข่าย", titleEN: "Network Systems" },
    ],
    certifications: ["CE", "FCC"],
    warranty: { standard: "1 ปี", support: "บริการซ่อมและเปลี่ยนอะไหล่", note: "ราคาอาจมีการเปลี่ยนแปลงโดยไม่แจ้งล่วงหน้า" },
...

  {
    ...
    applications: [
      { icon: "🏭", titleTH: "ควบคุมอุตสาหกรรม", titleEN: "Industrial Control" },
      { icon: "⚙️", titleTH: "ระบบอัตโนมัติ", titleEN: "Automation" },
      { icon: "📊", titleTH: "ระบบข้อมูล", titleEN: "Data Systems" },
      { icon: "🌐", titleTH: "ระบบเครือข่าย", titleEN: "Network Systems" },
    ],
...

  {
    ...
    applications: [
      { icon: "🏭", titleTH: "ระบบควบคุมอุตสาหกรรม", titleEN: "Industrial Control" },
      { icon: "📡", titleTH: "ระบบสื่อสาร", titleEN: "Communication Systems" },
      { icon: "⚡", titleTH: "ระบบไฟฟ้า", titleEN: "Power Systems" },
      { icon: "🌐", titleTH: "ระบบเครือข่าย", titleEN: "Network Systems" },
    ],
    certifications: ["CE", "FCC", "IP65"],
...

  {
    ...
    applications: [
      { icon: "🏭", titleTH: "ควบคุมอุตสาหกรรม", titleEN: "Industrial Control" },
      { icon: "⚙️", titleTH: "ระบบอัตโนมัติ", titleEN: "Automation Systems" },
      { icon: "🔧", titleTH: "ระบบผลิต", titleEN: "Manufacturing" },
      { icon: "📊", titleTH: "ระบบจัดการ", titleEN: "Management Systems" },
    ],
    certifications: ["CE", "FCC", "IP65"],
    warranty: { standard: "1 ปี", support: "บริการซ่อมและเปลี่ยนอะไหล่", note: "ราคาอาจมีการเปลี่ยนแปลงโดยไม่แจ้งล่วงหน้า" },
  },
